...
<%
	...
	if(proc2.equals("ins")){
		...
		isInsert = dao2.insertComments(ins, board_no, mem_no);
	}
%>
</head>
...
<body>
		...
		<div id="main">
			...
			<div id="board01">
				...
				<form id="board">
					...
					<br>
					<div align="center">
						<input type="button" class="btn" value="수정" onclick="location.href='Myhome_board01Update.jsp?board_no=<%=bd.getBoard_no() %>'" />&nbsp;
						<input type="button" class="btn" id="delBtn" value="삭제" />&nbsp;
						<input type="button" class="btn" value="목록" onclick="location.href='Myhome_board01.jsp'" />
					</div>
				</form>
				<br>
				<div id="comments">
	...
	<script type="text/javascript">
		...
		if(isEnd){
			alert("삭제 완료했습니다.");
			location.href = "Myhome_board01.jsp";
		}
		// 댓글 등록
		...
		if(endDelete){
			alert("삭제 완료했습니다.");
			location.href = "Myhome_board01View.jsp?board_no="+bno;
		}
		// 폼 검사
