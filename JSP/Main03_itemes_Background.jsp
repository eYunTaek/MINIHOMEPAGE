...
<div style="height:1000px;width:250px;padding-top:50px;float:left" id="mySidebar">
  ...
  <div class="w3-large" style="font-weight:bold">
    ...
    <div id="demoAcc2" class="w3-bar-block w3-hide w3-padding-large w3-medium">
      ...
      <a href="Main03_itemes_Background.jsp" class="w3-bar-item w3-button " style="background-color:#ccc"><i class="fa fa-caret-right w3-margin-right"></i>배경화면</a>
    </div>
  </div>
...
<div style="float:left; padding-left:200px">
  <div>
     <br><br>
       <p style="font-weight:bold;font-size:25px;padding-right:150px" align="center">배경화면 목록</p>
      <table style="padding-left:50p" width="1300px" border;>
      <%int itemcnt=1; %>
      <%for(Item i:ilist) {
         if(i.getItem_type().equals("배경화면")){%>
            <%if(itemcnt%6==1){%><tr><%} %>
